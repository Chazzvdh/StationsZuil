...
stations = ["Amsterdam", "Haarlem", "Breda"]
...
list_val.set("Station")
option_menu = OptionMenu(window, list_val, "Amsterdam", "Haarlem", "Breda")
option_menu.configure(font=my_font2, activebackground="grey40", activeforeground="grey100", bg="grey25", fg="gray60")
option_menu.grid(row=0, column=0, ipady=10, ipadx=10, sticky=W)
...
l1 = Label(window, justify=LEFT, text=f"Station: {station}\nTemperature: {getData(station)[4]}°C\nDescription: {getData(station)[3]}")
l1.configure(bg="gray20", fg="gray80", font=my_font1, anchor="center")
l1.grid(row=1, column=0, rowspan=1, columnspan=1, ipadx=20, ipady=20, sticky=W)
